...
const SPELLS = [
...

  {
    ...
    name:'Psychic Bolt', cost:0, costType:'free',
  ...
  },
  {
    ...
    name:'Mind Scan', cost:0, costType:'free',
  ...
  },
  {
    ...
    name:'Warp Sight', cost:0, costType:'free',
  ...
  },
  {
    ...
    name:'Telepathic Link', cost:0, costType:'free',
  ...
  },
  {
    ...
    name:'Kinetic Ward', cost:0, costType:'free',
  ...
  },
  {
    ...
    name:'Neural Disruption', cost:0, costType:'free',
    action:'Bonus Action', range:'60ft', duration:'Instant', hasPerils:false,
    desc:'Target makes a CON save. Failure: disadvantage on their next attack roll, saving throw, or ability check (you declare which). Subtle — the target may not know you caused it.'
  },
  {
    id:'wrp_phase_shift', class:'librarian', tier:'base', tierLabel:'Base Power',
    name:'Phase Shift', cost:0, costType:'free',
  ...
  },
  {
    ...
    name:'Psychic Communion', cost:0, costType:'free',
    action:'Action', range:'30ft', duration:'Conc. 10 min', hasPerils:false,
    desc:'Share full senses with a willing ally — see, hear, and perceive everything they experience. Communicate complex tactical information instantly. You are not surprised while communing, regardless of your physical position.'
  },
  {
    id:'wrp_kinetic_lift', class:'librarian', tier:'base', tierLabel:'Base Power',
    name:'Kinetic Lift', cost:0, costType:'free',
    action:'Bonus Action', range:'60ft', duration:'Conc. 1 min', hasPerils:false,
    desc:'Telekinetically levitate an object (up to 500 lbs) or creature (Large or smaller). Object: move 20ft per turn free action. Creature: STR save or lifted 10ft and suspended. Levitated creatures can still act.'
  },
  {
    id:'wrp_warp_echo', class:'librarian', tier:'base', tierLabel:'Base Power',
    name:'Warp Echo', cost:0, costType:'free',
    action:'Action', range:'60ft radius', duration:'Instant', hasPerils:false,
    desc:'Open your mind to psychic residue of recent events. Receive visions of significant events within 60ft in the last 24 hours. Violence, deaths, and powerful emotions leave the strongest impressions. Cannot be used during active combat.'
  },
  ...
  {
    id:'wrp_smite_unclean', class:'librarian', tier:'rank1', tierLabel:'Rank I',
    name:'Smite the Unclean', cost:4, costType:'WRP',
  ...
  },
  {
    ...
    name:'Force Wave', cost:4, costType:'WRP',
    action:'Action', range:'30ft cone', duration:'Instant', hasPerils:false,
    desc:'Project a telekinetic burst in a 30ft cone. Each creature makes a STR save. Failure: 2d8 force damage and pushed 15ft. Success: half, no push. Objects up to 500 lbs are also pushed. Light cover is knocked aside.'
  },
  {
    id:'wrp_mind_grasp', class:'librarian', tier:'rank1', tierLabel:'Rank I',
    name:'Mind Grasp', cost:4, costType:'WRP',
    action:'Action', range:'30ft', duration:'Conc. 1 min', hasPerils:false,
  ...
  },
  {
    ...
    name:'Soul Sear', cost:4, costType:'WRP',
    action:'Action', range:'60ft', duration:'Instant', hasPerils:false,
    desc:'Lash out with a bolt of psychic fire. Target makes an INT save. Failure: 3d8 psychic damage and Frightened until end of their next turn. Success: half, not Frightened. Mindless creatures are immune to Frightened but take full damage.'
  },
  {
    id:'wrp_warp_speed', class:'librarian', tier:'rank1', tierLabel:'Rank I',
    name:'Warp Speed', cost:4, costType:'WRP',
  ...
  },
  {
    ...
    name:'Pyrokinesis', cost:4, costType:'WRP',
    action:'Action', range:'60ft', duration:'Ongoing', hasPerils:false,
    desc:'Ignite a target with warp-fueled psychic fire. Make a ranged spell attack. Hit: 3d6 fire damage and the target catches warp-fire — 1d6 fire damage at the start of each of their turns. DEX check (DC = Save DC) as an action to extinguish. Cannot be extinguished by mundane means.'
  },
  {
    id:'wrp_telepathic_assault', class:'librarian', tier:'rank1', tierLabel:'Rank I',
    name:'Telepathic Assault', cost:5, costType:'WRP',
    action:'Action', range:'60ft', duration:'Instant', hasPerils:false,
  ...
  },
  {
    ...
    name:'Null Field', cost:5, costType:'WRP',
  ...
  },
  {
    ...
    name:'Veil of Time', cost:5, costType:'WRP',
  ...
  },
  {
    ...
    name:'Psychic Shroud', cost:5, costType:'WRP',
    action:'Action', range:'Self', duration:'Conc. 1 min', hasPerils:false,
    desc:'Bend light and mental perception around yourself. You become invisible; your thoughts cannot be read. Ends immediately on any hostile action. Other psykers within 30ft detect your presence on an INT check (DC = Save DC).'
  },
  {
    id:'wrp_psychic_scour', class:'librarian', tier:'rank1', tierLabel:'Rank I',
    name:'Psychic Scour', cost:5, costType:'WRP',
    action:'Action', range:'30ft', duration:'Instant', hasPerils:false,
    desc:'Burn away a negative condition afflicting an ally with focused psychic energy. Remove one of the following from a willing ally: Blinded, Deafened, Frightened, Poisoned, or one level of Exhaustion. Alternatively, clear one non-magical disease.'
  },
  {
    id:'wrp_ectoplasmic_tendrils', class:'librarian', tier:'rank1', tierLabel:'Rank I',
    name:'Ectoplasmic Tendrils', cost:5, costType:'WRP',
    action:'Action', range:'30ft', duration:'Conc. 1 min', hasPerils:false,
  ...
  },
  {
    ...
    name:'Mental Bastion', cost:4, costType:'WRP',
  ...
  },
  {
    ...
    name:'Crushing Grasp', cost:5, costType:'WRP',
    action:'Action', range:'60ft', duration:'Instant', hasPerils:false,
    desc:'Compress air around a creature into a crushing telekinetic vice. Target makes a CON save. Failure: 4d8 force damage and Incapacitated until start of their next turn. Success: 2d8, not Incapacitated. Creatures in power armor have disadvantage.'
  },
  {
    id:'wrp_mindlink_network', class:'librarian', tier:'rank1', tierLabel:'Rank I',
    name:'Mindlink Network', cost:5, costType:'WRP',
  ...
  },
  {
    ...
    name:'Far Sight', cost:5, costType:'WRP',
    action:'Action', range:'Unlimited', duration:'Conc. 10 min', hasPerils:false,
    desc:'Extend psychic senses across vast distances. Choose a location you have previously visited. For the duration, see and hear that location as if present. You are blind and deaf to your actual surroundings while projecting. Excellent for pre-mission reconnaissance.'
  },
  {
    id:'wrp_warp_construct', class:'librarian', tier:'rank1', tierLabel:'Rank I',
    name:'Warp Construct', cost:6, costType:'WRP',
    action:'Action', range:'30ft', duration:'1 hour', hasPerils:false,
  ...
  },
  {
    ...
    name:'Memory Wipe', cost:6, costType:'WRP',
    action:'Action', range:'30ft', duration:'Permanent', hasPerils:false,
  ...
  {
    id:'wrp_gate_infinity_1', class:'librarian', tier:'rank1', tierLabel:'Rank I',
    name:'Gate of Infinity I', cost:6, costType:'WRP',
    action:'Bonus Action', range:'Self (30ft)', duration:'Instant', hasPerils:false,
  ...
  },
  {
    ...
    name:'Temporal Echo', cost:6, costType:'WRP',
    action:'Action', range:'30ft (30ft radius)', duration:'Instant', hasPerils:false,
    desc:'Briefly replay the last 6 seconds in a 30ft radius. All creatures in the area make WIS saves. Failure: displaced back 6 seconds — their position, HP, and conditions reset to start of last turn. They lose memory of that turn\'s events. Success: unaffected. Closely monitored by the Librarius.'
  },
...

  {
    ...
    name:'Might of Heroes', cost:8, costType:'WRP',
    action:'Bonus Action', range:'30ft', duration:'Conc. 1 min', hasPerils:false,
    desc:'Flood one ally\'s biology with psychic enhancement. Target gains +4 STR, DEX, and CON, movement +20ft, and may make one additional attack when taking the Attack action. Highly visible — target emanates a psychic aura.'
  },
  {
    id:'wrp_prescience', class:'librarian', tier:'rank2', tierLabel:'Rank II',
    name:'Prescience', cost:8, costType:'WRP',
    action:'Bonus Action', range:'Self', duration:'Conc. 1 min', hasPerils:false,
  ...
  },
  {
    ...
    name:'Psychic Fortress', cost:8, costType:'WRP',
    action:'Action', range:'30ft (self + allies)', duration:'Until depleted', hasPerils:false,
    desc:'Project a shared psychic barrier around yourself and up to 3 allies. Each gains temporary HP equal to 2d10 + INT modifier. While any temp HP from this power remains, the target has resistance to psychic damage.'
  },
  {
    id:'wrp_hallucination', class:'librarian', tier:'rank2', tierLabel:'Rank II',
    name:'Hallucination', cost:8, costType:'WRP',
    action:'Action', range:'60ft', duration:'Conc. 1 min', hasPerils:false,
  ...
  },
  {
    ...
    name:'Force Cage', cost:8, costType:'WRP',
    action:'Action', range:'60ft', duration:'Conc. 1 hour', hasPerils:false,
    desc:'Imprison a creature in an invisible telekinetic cage. Target makes a STR save. Failure: contained in a 10ft force cube — cannot move, teleport, or be moved. Can still attack and act. The cage has no physical component. Success: 2d8 force damage, no cage.'
  },
  {
    id:'wrp_biomantic_surge', class:'librarian', tier:'rank2', tierLabel:'Rank II',
    name:'Biomantic Surge', cost:8, costType:'WRP',
    action:'Bonus Action', range:'30ft', duration:'Conc. 1 min', hasPerils:false,
    desc:'Dramatically enhance an ally\'s physical biology. One ally gains: STR and CON become 20, movement doubles, one free attack when an enemy enters melee range, and they need not breathe. When the duration ends: target gains 1 level of Exhaustion.'
  },
  {
    id:'wrp_dominate_mind', class:'librarian', tier:'rank2', tierLabel:'Rank II',
    name:'Dominate Mind', cost:10, costType:'WRP',
    action:'Action', range:'60ft', duration:'Conc. 1 min', hasPerils:false,
  ...
  },
  {
    ...
    name:'Soul Blaze', cost:10, costType:'WRP',
    action:'Action', range:'60ft', duration:'Conc. 1 min', hasPerils:false,
    desc:'Set a target\'s soul alight with warp-fire. Target makes a CON save. Failure: 4d6 psychic damage now, plus 2d6 psychic damage at start of each of their turns. Success: 2d6, no ongoing. Action to reattempt the CON save and extinguish the blaze.'
  },
  {
    id:'wrp_psychic_transference', class:'librarian', tier:'rank2', tierLabel:'Rank II',
    name:'Psychic Transference', cost:8, costType:'WRP',
    action:'Reaction (ally takes damage)', range:'60ft', duration:'Instant', hasPerils:false,
    desc:'When an ally within 60ft takes damage, redirect it psychically. The ally takes no damage — the damage source takes half the original amount as psychic damage (no save), and your ally takes the other half as psychic damage. Net: damage is split and partially reflected back.'
  },
  {
    id:'wrp_storm_emperors_wrath', class:'librarian', tier:'rank2', tierLabel:'Rank II',
    name:'Storm of the Emperor\'s Wrath', cost:10, costType:'WRP',
    action:'Action', range:'Self (60ft cone)', duration:'Instant', hasPerils:false,
    desc:'Call down crackling psychic lightning in a 60ft cone. Each creature makes a DEX save. Failure: 5d8 lightning + 3d8 psychic damage. Success: half. Metallic armor grants no protection — armored targets have disadvantage on the save.'
  },
  {
    id:'wrp_null_storm', class:'librarian', tier:'rank2', tierLabel:'Rank II',
    name:'Null Storm', cost:10, costType:'WRP',
    action:'Action', range:'60ft (30ft radius)', duration:'Conc. 10 min', hasPerils:false,
  ...
  },
  {
    ...
    name:'Brain Burst', cost:10, costType:'WRP',
    action:'Action', range:'60ft', duration:'Instant', hasPerils:false,
  ...
  },
  {
    ...
    name:'Warp Rift', cost:10, costType:'WRP',
    action:'Action', range:'60ft (10×30ft line)', duration:'1 minute', hasPerils:false,
  ...
  },
  {
    ...
    name:'Warp Horror', cost:10, costType:'WRP',
    action:'Action', range:'60ft (30ft radius)', duration:'Conc. 1 min', hasPerils:false,
  ...
  },
  {
    ...
    name:'Cognitive Override', cost:10, costType:'WRP',
    action:'Action', range:'30ft', duration:'Until resupply', hasPerils:false,
    desc:'Convince a creature\'s mind it never experienced this encounter. Target makes an INT save. Failure: forgets having seen you or your kill team entirely — loses all tactical knowledge of positions and capabilities gained this combat. Will not pursue, report, or remember the engagement.'
  },
  {
    id:'wrp_gestalt_mind', class:'librarian', tier:'rank2', tierLabel:'Rank II',
    name:'Gestalt Mind', cost:10, costType:'WRP',
    action:'Action', range:'30ft', duration:'Conc. 10 min', hasPerils:false,
    desc:'Temporarily merge the tactical consciousness of up to 4 willing allies. Linked members may share action economy, all have advantage on attacks against any creature that attacked any member, and cannot be Surprised. When the gestalt ends, all participants take 1d6 psychic damage.'
  },
  {
    id:'wrp_dimensional_step', class:'librarian', tier:'rank2', tierLabel:'Rank II',
    name:'Dimensional Step', cost:10, costType:'WRP',
    action:'Bonus Action', range:'Self (90ft)', duration:'Instant', hasPerils:false,
    desc:'Phase through the Warp in a streak of violet energy, crossing up to 90ft — including through solid matter up to 5ft thick. Line of sight is not required, only knowledge of the destination. If you phase into solid matter, take 4d10 force damage and shunt to nearest open space.'
  },
  {
    id:'wrp_vortex_of_doom', class:'librarian', tier:'rank2', tierLabel:'Rank II',
    name:'Vortex of Doom', cost:12, costType:'WRP',
    action:'Action', range:'60ft (20ft radius)', duration:'Conc. 1 min', hasPerils:false,
  ...
  },
  {
    ...
    name:'Reality Shear', cost:12, costType:'WRP',
    action:'Action', range:'60ft', duration:'Instant', hasPerils:false,
    desc:'Tear apart the quantum structure of reality around a target. Target makes a CON save. Failure: 8d8 force damage and one of their equipped items is permanently destroyed as molecular bonds are severed. Success: 4d8 damage, no item destruction. Ignores damage resistances and immunities.'
  },
  {
    id:'wrp_gate_infinity_2', class:'librarian', tier:'rank2', tierLabel:'Rank II',
    name:'Gate of Infinity II', cost:12, costType:'WRP',
    action:'Action', range:'Self + 3 allies (60ft)', duration:'Instant', hasPerils:false,
    desc:'Step through a larger warp gate bringing allies. Up to 3 willing creatures within 10ft of you teleport with you to a destination within 60ft. All transported creatures make WIS saves (DC 10) or are Disoriented until end of their next turn.'
  },
  ...
  {
    id:'wrp_nexus_of_power', class:'librarian', tier:'rank3', tierLabel:'Rank III',
    name:'Nexus of Power', cost:12, costType:'WRP',
    action:'Bonus Action', range:'Self', duration:'Instant (next power)', hasPerils:false,
    desc:'Concentrate psychic power into a moment of absolute clarity. The next Advanced Warp Power you manifest before end of turn costs 0 WRP, skips Perils checks, and deals maximum damage / achieves maximum effect. That power\'s save DCs increase by 2.'
  },
  {
    id:'wrp_reality_anchor', class:'librarian', tier:'rank3', tierLabel:'Rank III',
    name:'Reality Anchor', cost:14, costType:'WRP',
    action:'Action', range:'60ft (30ft radius)', duration:'Conc. 10 min', hasPerils:false,
    desc:'Lock down the laws of physics in a 30ft radius. Within the area: no teleportation of any kind, no summoning or banishment, no extradimensional spaces can be accessed. Affects everyone equally — including you. Plan accordingly.'
  },
  {
    id:'wrp_mind_shatter', class:'librarian', tier:'rank3', tierLabel:'Rank III',
    name:'Mind Shatter', cost:14, costType:'WRP',
    action:'Action', range:'60ft', duration:'Permanent', hasPerils:false,
    desc:'Launch a devastating attack designed to permanently damage the target\'s mind. Target makes an INT save. Failure: 6d12 psychic damage and INT permanently reduced by 1d6. If INT reaches 0, vegetative state. Success: 6d12, no reduction. Cannot target constructs.'
  },
  {
    id:'wrp_purge_soul', class:'librarian', tier:'rank3', tierLabel:'Rank III',
    name:'Purge Soul', cost:14, costType:'WRP',
    action:'Action', range:'60ft', duration:'Instant', hasPerils:false,
    desc:'Reach into a target\'s soul and attempt to rip it out. Target makes a CON save. Failure: 10d10 psychic damage. Success: 5d10. If reduced to 0 HP, the target cannot be stabilized — their soul scatters to the Warp.'
  },
  {
    id:'wrp_astral_projection', class:'librarian', tier:'rank3', tierLabel:'Rank III',
    name:'Astral Projection', cost:14, costType:'WRP',
    action:'Action', range:'Self', duration:'Conc. 10 min', hasPerils:false,
    desc:'Leave your physical body behind and project your psychic consciousness across the battlefield. Your astral form is invisible, flies 60ft, and can observe everything within 300ft of your body. You can communicate mentally with anyone you can see. Your body is helpless (AC 10, cannot act).'
  },
  {
    id:'wrp_entropy_field', class:'librarian', tier:'rank3', tierLabel:'Rank III',
    name:'Entropy Field', cost:14, costType:'WRP',
    action:'Action', range:'60ft (20ft radius)', duration:'Conc. 1 min', hasPerils:false,
    desc:'Project a field of accelerated entropy. All enemies in the radius make CON saves at start of each turn. Failure: weapons deal -1d6 damage (cumulative), armor loses 1 AC (cumulative), and they take 3d8 necrotic. Success: 2d8 necrotic. After 3 failures, equipment is destroyed. Deterioration is permanent unless repaired.'
  },
  {
    id:'wrp_gate_infinity_3', class:'librarian', tier:'rank3', tierLabel:'Rank III',
    name:'Gate of Infinity III', cost:14, costType:'WRP',
    action:'Action', range:'30ft (dest. 300ft)', duration:'Instant', hasPerils:false,
  ...
  },
  {
    ...
    name:'Temporal Stasis', cost:14, costType:'WRP',
    action:'Action', range:'60ft', duration:'Up to 1 hour', hasPerils:false,
  ...
  },
  {
    ...
    name:'Mass Dominion', cost:14, costType:'WRP',
    action:'Action', range:'60ft (30ft radius)', duration:'Conc. 1 min', hasPerils:false,
    desc:'Extend your psychic will to dominate multiple minds. Up to 3 creatures of your choice within 30ft make WIS saves. Failures are Charmed and under your mental control. A single bonus action command applies to all dominated creatures simultaneously.'
  },
  {
    id:'wrp_warp_siphon', class:'librarian', tier:'rank3', tierLabel:'Rank III',
    name:'Warp Siphon', cost:14, costType:'WRP',
    action:'Action', range:'60ft', duration:'Instant', hasPerils:false,
    desc:'Reach into an enemy psyker and rip their power out. Target makes an INT save. Failure: their power pool is reduced by 25% for this encounter; you regain WRP equal to what they lost (max 15 WRP). Success: 5d10 psychic damage only. Cannot target non-psychic targets.'
  },
  {
    id:'wrp_veil_between_worlds', class:'librarian', tier:'rank3', tierLabel:'Rank III',
    name:'Veil Between Worlds', cost:16, costType:'WRP',
    action:'Action', range:'60ft', duration:'1 minute', hasPerils:true,
    desc:'Banish one creature to a Warp pocket. Target makes a CHA save. Failure: vanishes for 1 minute in a hellish pocket dimension, returning to an unoccupied space within 10ft with 2 levels of Exhaustion. Success: unaffected. ⚠ Triggers Perils Check.'
  },
  {
    id:'wrp_psychic_scream', class:'librarian', tier:'rank3', tierLabel:'Rank III',
    name:'Psychic Scream', cost:16, costType:'WRP',
    action:'Action', range:'Self (90ft radius)', duration:'Instant', hasPerils:true,
    desc:'Unleash a psychic shriek shredding minds across a massive area. All enemies within 90ft make INT saves. Failure: 8d8 psychic damage and Stunned until end of their next turn. Success: 4d8. Constructs and mindless creatures are immune. Allies within 30ft make WIS saves (DC 12) or are Deafened 1 minute. ⚠ Triggers Perils Check.'
  },
  {
    id:'wrp_psychic_sundering', class:'librarian', tier:'rank3', tierLabel:'Rank III',
    name:'Psychic Sundering', cost:16, costType:'WRP',
    action:'Action', range:'60ft', duration:'Permanent', hasPerils:true,
    desc:'Strike at the very core of a psyker\'s being. Target must be a psyker or spellcaster — makes an INT save at disadvantage. Failure: psychic/magical abilities permanently suppressed. Success: 8d12 psychic damage. ⚠ Triggers Perils Check.'
  },
  {
    id:'wrp_apotheosis', class:'librarian', tier:'rank3', tierLabel:'Rank III',
    name:'Apotheosis', cost:16, costType:'WRP',
    action:'Action', range:'Self', duration:'Conc. 1 min', hasPerils:true,
    desc:'Shed your physical form and become a being of pure psychic energy. Immune to physical damage, fly 60ft, each Warp Power deals +4d6 bonus psychic damage, emanate a 30ft aura — enemies make WIS saves or Frightened. When duration ends: automatic Perils check DC 18. ⚠ Mandatory Perils DC 18.'
  },
  {
    id:'wrp_warp_maw', class:'librarian', tier:'rank3', tierLabel:'Rank III',
    name:'Warp Maw', cost:16, costType:'WRP',
    action:'Action', range:'60ft', duration:'Until escaped', hasPerils:true,
    desc:'Open a mouth of pure void beneath a target. DEX save. Failure: 8d12 force damage and Swallowed into the Warp — incapacitated, 4d6 force/turn. WIS save each turn to claw back, reappearing within 10ft of you. Success: 4d12 only. ⚠ Triggers Perils Check.'
  },
  {
    id:'wrp_living_vortex', class:'librarian', tier:'rank3', tierLabel:'Rank III',
    name:'Living Vortex', cost:16, costType:'WRP',
    action:'Action', range:'Self (20ft radius)', duration:'Conc. 1 min', hasPerils:true,
    desc:'Become one with a Warp Vortex. Your form dissolves into a 20ft storm of psychic energy. Immune to physical damage. Any creature starting its turn within 20ft takes 5d8 force + 5d8 psychic (DEX save for half). Perils check each turn (WIS DC 15). If concentration breaks: reappear at 1 HP. ⚠ Ongoing Perils DC 15.'
  },
  {
    id:'wrp_cataclysmic_pyrokinesis', class:'librarian', tier:'rank3', tierLabel:'Rank III',
    name:'Cataclysmic Pyrokinesis', cost:16, costType:'WRP',
    action:'Action', range:'120ft (40ft radius)', duration:'Conc. 1 min', hasPerils:true,
    desc:'Unleash a catastrophic psychic inferno. All creatures in 40ft radius make DEX saves. Failure: 6d8 fire + 6d8 psychic and caught in warp-fire (2d8/turn). Success: half, no ongoing. Within the area: visibility 10ft, movement costs double, non-airtight armor users make CON saves each turn or gain 1 Exhaustion. ⚠ Mandatory Perils Check.'
  },
  {
    id:'wrp_the_emperors_wrath', class:'librarian', tier:'rank3', tierLabel:'Rank III',
    name:'The Emperor\'s Wrath', cost:18, costType:'WRP',
    action:'Action', range:'120ft (20ft radius)', duration:'Instant', hasPerils:true,
    desc:'Channel the raw psychic might of the Emperor\'s will. All creatures in a 20ft radius sphere make DEX saves. Failure: 8d8 lightning + 8d8 psychic damage. Success: half. The ground becomes difficult terrain; all warp effects active within are immediately dispelled. ⚠ Mandatory Perils Check.'
  },
  {
    id:'wrp_psychic_annihilation', class:'librarian', tier:'rank3', tierLabel:'Rank III',
    name:'Psychic Annihilation', cost:18, costType:'WRP',
    action:'Action', range:'60ft', duration:'Instant', hasPerils:true,
    desc:'Pure psychic energy that disassembles matter at the molecular level. Target makes a CON save. Failure: 12d12 psychic damage. If reduced to 0 HP, the target is completely disintegrated — every molecule dispersed. Success: 6d12. Automatically triggers a Perils check at DC 16. ⚠ Mandatory Perils DC 16.'
  },
...

  {
    ...
    name:'Sacred Flame', cost:0, costType:'free',
    action:'Action', range:'60ft', duration:'Instant', hasPerils:false,
  ...
  },
  {
    ...
    name:'Word of Censure', cost:0, costType:'free',
  ...
  },
  {
    ...
    name:'Guidance', cost:0, costType:'free',
  ...
  },
  {
    ...
    name:'Toll the Dead', cost:0, costType:'free',
    action:'Action', range:'60ft', duration:'Instant', hasPerils:false,
  ...
  },
  {
    ...
    name:'Mending Prayer', cost:0, costType:'free',
    action:'Bonus Action', range:'30ft', duration:'Instant', hasPerils:false,
  ...
  },
  {
    ...
    name:'Righteous Fury', cost:0, costType:'free',
  ...
  },
  {
    ...
    name:'Last Rites', cost:0, costType:'free',
    action:'Bonus Action', range:'30ft', duration:'Instant', hasPerils:false,
  ...
  },
  {
    ...
    name:'Holy Light', cost:0, costType:'free',
  ...
  {
    id:'ebp_kneel_before_emperor', class:'chaplain', tier:'base', tierLabel:'Base Power',
    name:'Kneel Before the Emperor', cost:0, costType:'free',
  ...
  },
  {
    ...
    name:'Sanctify', cost:0, costType:'free',
...

  {
    ...
    name:'Divine Smite', cost:4, costType:'EBP',
  ...
  },
  {
    ...
    name:'Bless', cost:4, costType:'EBP',
    action:'Action', range:'30ft', duration:'Conc. 10 min', hasPerils:false,
  ...
  },
  {
    ...
    name:'Cure Wounds', cost:4, costType:'EBP',
  ...
  },
  {
    ...
    name:'Shield of Faith', cost:4, costType:'EBP',
  ...
  },
  {
    ...
    name:'Command', cost:4, costType:'EBP',
  ...
  },
  {
    ...
    name:'Holy Fervor', cost:4, costType:'EBP',
    action:'Bonus Action', range:'30ft', duration:'Until end of next turn', hasPerils:false,
    desc:'Ignite one ally with divine battle-rage. Target may immediately make one additional Attack action this turn. Each attack deals an additional 1d6 radiant damage. Using on the same ally more than once per encounter risks 1 level of Exhaustion.'
  },
  {
    id:'ebp_battle_hymn', class:'chaplain', tier:'dev1', tierLabel:'Devotion I',
    name:'Battle Hymn', cost:4, costType:'EBP',
  ...
  {
    id:'ebp_emperors_grace', class:'chaplain', tier:'dev1', tierLabel:'Devotion I',
    name:'Emperor\'s Grace', cost:4, costType:'EBP',
    action:'Reaction (ally takes damage)', range:'60ft', duration:'Instant', hasPerils:false,
    desc:'When an ally within 60ft takes damage, reduce that damage by 2d8 + CHA modifier as a reaction. Applied after the damage roll, before resistances or immunities. Can be used once per round regardless of how many reactions you have available.'
  },
  {
    id:'ebp_thunderous_rebuke', class:'chaplain', tier:'dev1', tierLabel:'Devotion I',
    name:'Thunderous Rebuke', cost:5, costType:'EBP',
  ...
  },
  {
    ...
    name:'Searing Brand', cost:4, costType:'EBP',
    action:'Bonus Action', range:'60ft', duration:'Conc. 1 min', hasPerils:false,
  ...
  },
  {
    ...
    name:'Iron Will', cost:4, costType:'EBP',
  ...
  },
  {
    ...
    name:'Protection from Corruption', cost:5, costType:'EBP',
    action:'Action', range:'30ft', duration:'Conc. 1 hour', hasPerils:false,
    desc:'Speak a ward against the Warp over up to 3 allies. Targets gain advantage on saves against Corruption effects, psychic damage, daemonic possession, and warp-based conditions. Daemonic and Chaos-aligned entities have disadvantage on attack rolls against warded targets.'
  },
  {
    id:'ebp_consecrate_weapon', class:'chaplain', tier:'dev1', tierLabel:'Devotion I',
    name:'Consecrate Weapon', cost:5, costType:'EBP',
    action:'Bonus Action', range:'Touch', duration:'10 min', hasPerils:false,
    desc:'Consecrate one weapon with holy light. The weapon deals an additional 1d6 radiant damage per hit and counts as magical. Against daemons and Chaos-aligned creatures: 2d6 radiant. The weapon glows visibly while consecrated.'
  },
  {
    id:'ebp_blessed_ammunition', class:'chaplain', tier:'dev1', tierLabel:'Devotion I',
    name:'Blessed Ammunition', cost:5, costType:'EBP',
    action:'Action', range:'Touch', duration:'Until resupply', hasPerils:false,
    desc:'Consecrate one magazine or ammunition source with holy light. All ranged attacks using this ammunition deal an additional 1d4 radiant damage per hit and count as magical. Against daemons and Chaos-aligned creatures: 1d8 radiant. The ammunition glows faintly.'
  },
  {
    id:'ebp_penitents_strike', class:'chaplain', tier:'dev1', tierLabel:'Devotion I',
    name:'Penitent\'s Strike', cost:4, costType:'EBP',
    action:'Bonus Action', range:'30ft', duration:'Until end of next turn', hasPerils:false,
    desc:'Grant one ally who has taken damage this encounter the will to strike harder. For their next attack roll, they may add the total damage they have taken this combat as a bonus to damage (maximum +20). Pain transformed into purpose.'
  },
  {
    id:'ebp_voice_of_command', class:'chaplain', tier:'dev1', tierLabel:'Devotion I',
    name:'Voice of Command', cost:4, costType:'EBP',
    action:'Bonus Action', range:'30ft', duration:'Instant', hasPerils:false,
    desc:'Grant one ally their reaction immediately — even if they have already used it this round. They may use it as any reaction ability they possess, not just reactions normally available as reactions. Represents the Chaplain\'s ability to unlock split-second heroism at the critical moment.'
  },
  {
    id:'ebp_martyrdoms_resolve', class:'chaplain', tier:'dev1', tierLabel:'Devotion I',
    name:'Martyrdom\'s Resolve', cost:5, costType:'EBP',
    action:'Reaction (ally drops to 0 HP)', range:'60ft', duration:'1 round', hasPerils:false,
    desc:'When an ally drops to exactly 0 HP (not killed outright), empower them with one final act of will. They remain standing at 0 HP, make no death saving throws, and take one full turn (action, bonus action, movement) before falling unconscious. Any action they take deals maximum damage.'
  },
  {
    id:'ebp_aura_of_purity', class:'chaplain', tier:'dev1', tierLabel:'Devotion I',
    name:'Aura of Purity', cost:5, costType:'EBP',
    action:'Action', range:'Self (15ft radius)', duration:'Conc. 10 min', hasPerils:false,
    desc:'Radiate a constant wave of purifying faith. Allies within the radius reduce their Corruption by 1 point at the end of each minute while present. Any ally gaining Corruption within the aura may immediately make a WIS save (DC 12) — success reduces the Corruption gain by 1.'
  },
  {
    id:'ebp_holy_barrier', class:'chaplain', tier:'dev1', tierLabel:'Devotion I',
    name:'Holy Barrier', cost:5, costType:'EBP',
    action:'Action', range:'60ft', duration:'Conc. 10 min', hasPerils:false,
    desc:'Create an immovable wall of divine force — up to 20ft long, 10ft high, 1ft thick. The wall has AC 18, 60 HP and provides full cover. Daemons and undead cannot pass through. Chaos-aligned creatures that touch the wall take 2d6 radiant damage.'
  },
  {
    id:'ebp_wrathful_sermon', class:'chaplain', tier:'dev1', tierLabel:'Devotion I',
    name:'Wrathful Sermon', cost:5, costType:'EBP',
    action:'Action', range:'Self (20ft radius)', duration:'Instant', hasPerils:false,
    desc:'Deliver a devastating verse condemning your enemies. All enemies within 20ft who can hear you make WIS saves. Failure: 2d8 thunder damage and Stunned until end of their next turn. Success: half, not Stunned. Creatures that cannot understand language are immune to the Stun but take full damage.'
  },
...

  {
    ...
    name:'Spiritual Crusader', cost:8, costType:'EBP',
    action:'Bonus Action', range:'60ft', duration:'Conc. 1 min', hasPerils:false,
  ...
  },
  {
    ...
    name:'Silence the Warp', cost:8, costType:'EBP',
    action:'Action', range:'60ft (20ft radius)', duration:'Conc. 10 min', hasPerils:false,
    desc:'Create a zone of holy silence crushing psychic energies. Within the radius, no spells can be cast and no Warp Powers manifested. Daemons/warp entities have disadvantage on all attacks and saves. This affects all psychic abilities regardless of source — including allied psykers. Plan accordingly.'
  },
  {
    id:'ebp_hold_the_line', class:'chaplain', tier:'dev2', tierLabel:'Devotion II',
    name:'Hold the Line', cost:8, costType:'EBP',
  ...
  },
  {
    ...
    name:'Beacon of Faith', cost:8, costType:'EBP',
  ...
  },
  {
    ...
    name:'Mass Cure Wounds', cost:10, costType:'EBP',
  ...
  },
  {
    ...
    name:'Flame of Purity', cost:10, costType:'EBP',
    action:'Action', range:'Self (60ft cone)', duration:'Instant', hasPerils:false,
  ...
  },
  {
    ...
    name:'Divine Mantle', cost:10, costType:'EBP',
    action:'Action', range:'Self (20ft radius)', duration:'Conc. 1 min', hasPerils:false,
    desc:'Cloak your allies in holy radiance. All allies within 20ft deal an additional 1d6 radiant damage on every melee hit. Enemies striking allies within the mantle make a CON save or are Blinded until end of their next turn. Visible as a golden aura around each ally.'
  },
  {
    id:'ebp_rite_of_exorcism', class:'chaplain', tier:'dev2', tierLabel:'Devotion II',
    name:'Rite of Exorcism', cost:12, costType:'EBP',
    action:'Action', range:'30ft', duration:'Instant', hasPerils:false,
    desc:'Perform a focused exorcism against a daemonic, possessed, or Chaos-aligned entity. Target makes a CHA save at disadvantage. Failure: entity Banished to the Warp for 1 minute. If the target is possessed, the possession ends — host survives at 1 HP. Success: 4d10 radiant damage.'
  },
  {
    id:'ebp_word_of_recall', class:'chaplain', tier:'dev2', tierLabel:'Devotion II',
    name:'Word of Recall', cost:10, costType:'EBP',
    action:'Reaction (on ally drop to 0 HP)', range:'60ft', duration:'Instant', hasPerils:false,
  ...
  },
  {
    ...
    name:'War Sermon', cost:8, costType:'EBP',
    action:'Action', range:'Self (30ft radius)', duration:'Conc. 1 min', hasPerils:false,
    desc:'Deliver an ongoing sermon of divine warfare. While preaching you cannot use other bonus actions. Ally bonus scales: 1–2 allies: +1d4 damage. 3–4 allies: +1d6 damage. 5+ allies: +1d8 damage and advantage on saving throws. Your highest expression of battlefield leadership.'
  },
  {
    id:'ebp_consecrated_ground', class:'chaplain', tier:'dev2', tierLabel:'Devotion II',
    name:'Consecrated Ground', cost:8, costType:'EBP',
    action:'Action', range:'60ft (20ft radius)', duration:'1 hour', hasPerils:false,
    desc:'Consecrate the ground in a 20ft radius. Within: all healing increased by 1d6, allies have advantage on saves against fear and Corruption, and enemies must make WIS saves to enter. Daemons and undead cannot enter at all — it is an absolute divine barrier to them.'
  },
  {
    id:'ebp_absolution', class:'chaplain', tier:'dev2', tierLabel:'Devotion II',
    name:'Absolution', cost:8, costType:'EBP',
    action:'Action', range:'30ft', duration:'Instant', hasPerils:false,
    desc:'Perform a rite of cleansing absolution on one willing ally. Reduce the target\'s Corruption score by 1d4. The Chaplain\'s unique ability to address the soul directly — not just the body. At Level 14+, this reduces Corruption by 2d4 instead.'
  },
  {
    id:'ebp_crusading_charge', class:'chaplain', tier:'dev2', tierLabel:'Devotion II',
    name:'Crusading Charge', cost:8, costType:'EBP',
    action:'Action', range:'Self (30ft radius)', duration:'Instant', hasPerils:false,
    desc:'Bellow a war cry and lead a charge in the Emperor\'s name. All allies within 30ft may immediately move up to their full movement speed toward any enemy they can see (no opportunity attacks provoked). If they end adjacent to an enemy, they make one additional melee attack.'
  },
  {
    id:'ebp_inquisitors_eye', class:'chaplain', tier:'dev2', tierLabel:'Devotion II',
    name:'Inquisitor\'s Eye', cost:10, costType:'EBP',
  ...
  },
  {
    ...
    name:'Unbreakable', cost:10, costType:'EBP',
    action:'Reaction (on lethal hit to ally)', range:'60ft', duration:'Instant', hasPerils:false,
    desc:'When an ally within 60ft would be killed (reduced to 0 HP by damage that would kill them outright), declare them Unbreakable. The killing blow is reduced to leave them at exactly 1 HP — they survive. Usable once per ally per resupply. The Unbreakable warrior gains +2 to all rolls for 1 round.'
  },
  {
    id:'ebp_chains_of_penance', class:'chaplain', tier:'dev2', tierLabel:'Devotion II',
    name:'Chains of Penance', cost:10, costType:'EBP',
    action:'Action', range:'60ft', duration:'Conc. 1 min', hasPerils:false,
    desc:'Bind an enemy in divine chains of radiant energy. Target makes a STR save. Failure: Restrained and takes 2d6 radiant damage at start of each of their turns. Cannot teleport or use warp movement while chained. STR save each turn to break free. Daemons have disadvantage on the save.'
  },
  {
    id:'ebp_holy_sundering', class:'chaplain', tier:'dev2', tierLabel:'Devotion II',
    name:'Holy Sundering', cost:12, costType:'EBP',
    action:'Action', range:'30ft', duration:'Instant', hasPerils:false,
    desc:'Project the Emperor\'s authority to unmake heretical magic. Choose one: destroy one non-artifact magic item on an enemy (CHA save to resist), dispel all ongoing effects on a target, or destroy one summoned creature outright (CON save — fail: instant death, success: 8d10 radiant).'
  },
  {
    id:'ebp_last_sacrament', class:'chaplain', tier:'dev2', tierLabel:'Devotion II',
    name:'Last Sacrament', cost:10, costType:'EBP',
    action:'Action', range:'30ft', duration:'Until end of next turn', hasPerils:false,
    desc:'Perform a swift sacrament over a critically wounded ally (at 25% HP or less). They are healed to full HP and become temporarily invulnerable — cannot be reduced below 1 HP by any means. When the invulnerability ends, they gain 2 levels of Exhaustion. A desperate measure.'
  },
  {
    id:'ebp_fortress_of_faith', class:'chaplain', tier:'dev2', tierLabel:'Devotion II',
    name:'Fortress of Faith', cost:10, costType:'EBP',
    action:'Action', range:'Self (20ft radius)', duration:'Conc. 1 min', hasPerils:false,
    desc:'Project an aura of divine protection. All allies within 20ft gain resistance to all damage types for the duration. The aura is visible as a shimmering golden field. Moving outside the radius ends the resistance immediately. The aura moves with you, always centered on your position.'
  },
...

  {
    ...
    name:'Holy Aegis', cost:12, costType:'EBP',
    action:'Action', range:'Self (30ft radius)', duration:'Conc. 1 min', hasPerils:false,
    desc:'Surround your kill team with an impenetrable holy barrier. All allies within 30ft gain immunity to psychic damage and advantage on all saves against Corruption effects. Warp-based effects targeting shielded allies automatically fail unless the caster succeeds on a CHA check vs your Holy Power Save DC.'
  },
  {
    id:'ebp_emperors_benediction', class:'chaplain', tier:'dev3', tierLabel:'Devotion III',
    name:'Emperor\'s Benediction', cost:12, costType:'EBP',
    action:'Action', range:'30ft', duration:'Instant', hasPerils:false,
  ...
  },
  {
    ...
    name:'Divine Retribution', cost:14, costType:'EBP',
    action:'Action', range:'Self (20ft radius)', duration:'Conc. 1 min', hasPerils:false,
  ...
  {
    id:'ebp_thrones_judgment', class:'chaplain', tier:'dev3', tierLabel:'Devotion III',
    name:'The Throne\'s Judgment', cost:14, costType:'EBP',
    action:'Action', range:'90ft', duration:'Instant', hasPerils:false,
    desc:'Pass divine judgment on a single creature. Target makes a CON save. Failure: 10d10 radiant damage. Success: 5d10. If this reduces the target to 0 HP, they are instantly and irreversibly slain — no death saves, no revival. Cannot be used on Imperium-aligned or Light-aligned creatures.'
  },
  {
    id:'ebp_litany_of_sacrifice', class:'chaplain', tier:'dev3', tierLabel:'Devotion III',
    name:'Litany of Sacrifice', cost:14, costType:'EBP',
  ...
  },
  {
    ...
    name:'Mass Banishment', cost:14, costType:'EBP',
    action:'Action', range:'Self (60ft radius)', duration:'1 min (or permanent)', hasPerils:false,
    desc:'Speak the Great Litany of Banishment. All daemons, warp entities, and Chaos-aligned creatures within 60ft make a CHA save. Failure: Banished to the Warp immediately. Maintained for 1 full minute: banishment becomes permanent for 100 years. Success: 6d10 radiant damage instead.'
  },
  {
    id:'ebp_resurrection_rite', class:'chaplain', tier:'dev3', tierLabel:'Devotion III',
    name:'Resurrection Rite', cost:12, costType:'EBP',
    action:'Action', range:'Touch', duration:'Instant', hasPerils:false,
    desc:'Perform the full Rites of Resurrection over a fallen warrior dead for no more than 1 hour. Target is revived with full HP. Returns with all conditions cleared, 1 level of Exhaustion, and advantage on all rolls for 1 minute. Cannot revive Chaos-tainted creatures or those claimed by the Warp.'
  },
  {
    id:'ebp_sanctuary', class:'chaplain', tier:'dev3', tierLabel:'Devotion III',
    name:'Sanctuary', cost:14, costType:'EBP',
    action:'Action', range:'30ft (30ft radius)', duration:'Conc. 10 min', hasPerils:false,
    desc:'Create a 30ft radius zone of complete divine protection. No enemy may enter voluntarily — they make WIS saves or their movement ends at the threshold. Enemies forced into the sanctuary take 4d10 radiant damage upon entry. Allies within gain advantage on all saving throws.'
  },
  {
    id:'ebp_crusade_of_faith', class:'chaplain', tier:'dev3', tierLabel:'Devotion III',
    name:'Crusade of Faith', cost:14, costType:'EBP',
  ...
  {
    id:'ebp_emperors_hand', class:'chaplain', tier:'dev3', tierLabel:'Devotion III',
    name:'Emperor\'s Hand', cost:14, costType:'EBP',
  ...
  },
  {
    ...
    name:'Wrath of the Emperor', cost:16, costType:'EBP',
    action:'Action', range:'120ft (10ft radius column)', duration:'Instant', hasPerils:false,
    desc:'Call down a pillar of holy fire — 10ft radius, 40ft tall. All within make a DEX save. Failure: 8d8 radiant damage. Success: half. Heretics and daemons fail the save automatically and take an additional 2d8 radiant at start of their next turn. Visible from miles away.'
  },
  {
    id:'ebp_storm_of_righteousness', class:'chaplain', tier:'dev3', tierLabel:'Devotion III',
    name:'Storm of Righteousness', cost:16, costType:'EBP',
  ...
  },
  {
    ...
    name:'Voice of the Emperor', cost:16, costType:'EBP',
    action:'Action', range:'Self (60ft radius)', duration:'Until end of round', hasPerils:false,
    desc:'Speak with the Emperor\'s voice — literally. All enemies within 60ft who can hear you make a WIS save. Failure: Stunned until end of their next turn as divine authority overwhelms them. Daemons and Chaos-aligned creatures have disadvantage and on failure are also Frightened for 1 minute.'
  },
  {
    id:'ebp_the_long_watch', class:'chaplain', tier:'dev3', tierLabel:'Devotion III',
    name:'The Long Watch', cost:16, costType:'EBP',
    action:'Action', range:'Self (30ft radius)', duration:'1 round', hasPerils:false,
  ...
  },
  {
    ...
    name:'Martyrdom Apotheosis', cost:16, costType:'EBP',
  ...
  },
  {
    ...
    name:'Avatar of Faith', cost:16, costType:'EBP',
    action:'Action', range:'Self', duration:'Conc. 1 min', hasPerils:false,
    desc:'The Emperor\'s power flows through you completely. For the duration: CHA becomes 22, all Holy Powers cost half EBP (rounded down), Crozius deals +3d8 radiant per hit, immunity to all conditions, and allies within 30ft regain 2d8 HP at start of each of your turns. When it ends: 3 levels of Exhaustion.'
  },
  {
    id:'ebp_in_nomine_imperatoris', class:'chaplain', tier:'dev3', tierLabel:'Devotion III',
    name:'In Nomine Imperatoris', cost:16, costType:'EBP',
